...
Phase 1 requires **no code changes** in **linux-whisper** or **LifeOS** — whisper-relay consumes public APIs/libraries only. See [ADR-002 § Upstream scope](adr/002-upstream-integration-boundaries.md#upstream-repos-no-phase-1-changes).

## Related repos

- **linux-whisper** — STT + polish (library import)
- **LifeOS** — orchestrator (HTTP client)
