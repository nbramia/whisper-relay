...
Curated principles for this repo, adapted from internal engineering notes. This file captures what applies to whisper-relay.
...
From internal architectural principles notes. Applied here:
...
**Source:** internal engineering principles notes (curated for whisper-relay)
